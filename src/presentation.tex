...
present thesis.
In \autoref{sec:overreact-methods}, particular attention is paid to the design
of \texttt{overreact}~\cite{Schneider2022}, a software package developed by the
...
Furthermore, publications that are not relevant to the field but were
nevertheless published during the course of the thesis are presented in
\autoref{ch:all-papers}.
...
Together with the already mentioned \autoref{ch:all-papers}, which lists all
