\PassOptionsToPackage{inline}{enumitem}  % inline itemizes
...
\usepackage{placeins}       % placement control

% # Utility packages
\usepackage{import}             % nestable, locally scoped import directives (note that it is best to use commands (e.g., `subimport{}{}`) in their own lines)
...
\usepackage[
	...
	backref,
	giveninits,
]{biblatex}                % cite according to ABNT
...
\subimport{./src/preamble}{quadros}  % definition of schemes (called quadros)
\subimport{./src/preamble}{info}     % general information such as title, author, etc.

\makeindex  % compile our index

% shortcuts
\newcommand{\overreact}{\texttt{overreact}\xspace}
% \newcommand{\overreactlogo}{\includegraphics[width=0.25\linewidth]{figures/logo.png}}
% \newcommand{\overreacthrefdoc}{\href{https://geem-lab.github.io/overreact-guide/}{\texttt{geem-lab.github.io/overreact-guide}}\xspace}
\newcommand{\cclib}{\texttt{cclib}\xspace}
\newcommand{\kcalmol}{kcal$\cdot$mol$^{-1}$\xspace}
